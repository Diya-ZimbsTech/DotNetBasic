...
namespace DatabaseFirstASPCore.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var StdData = await _context.Students.ToListAsync();
            return View(StdData);
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentName,StudentGender,Age,Standard")] Student student)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["Message"] = $"{student.StudentName} Added successfully.";
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentName,StudentGender,Age,Standard")] Student student)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    TempData["UMessage"] = $"{student.StudentName} Updated successfully.";
                    await _context.SaveChangesAsync();
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["DMessage"] = $"{student.StudentName} deleted successfully.";
            return RedirectToAction(nameof(Index));
        }
